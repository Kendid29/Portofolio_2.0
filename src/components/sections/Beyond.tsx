...
export function Beyond() {
  return (
    <section className="reveal-on-scroll relative w-full border-b-4 border-[var(--color-on-surface)] bg-[var(--color-surface)] py-[var(--spacing-space-lg)] lg:py-[var(--spacing-space-xl)] px-[var(--spacing-gutter)]" id="beyond" style={{ backgroundImage: "radial-gradient(var(--color-on-surface) 1.25px, transparent 1.25px)", backgroundSize: "28px 28px" }}>
      <div className="max-w-7xl mx-auto flex flex-col gap-10">
        <div className="flex flex-col gap-3">
          <div className="flex flex-wrap items-center gap-3 anim-spring-1">
            ...
            <span className="px-2 py-0.5 bg-[var(--color-surface-container-lowest)] border-2 border-[var(--color-on-surface)] shadow-[2px_2px_0px_0px_var(--color-on-surface)] font-label-caps text-[var(--font-label-caps)] font-bold text-[var(--color-on-surface)] float-badge-4 cursor-default select-none">
              OFF-SCREEN PURSUITS
            </span>
          </div>
          <h2 className="font-display text-3xl sm:text-5xl lg:text-6xl font-extrabold uppercase text-[var(--color-on-surface)] tracking-tight leading-[1.05] anim-spring-2">
            ...
            <span className="bg-[var(--color-secondary-container)] px-2 border-4 border-[var(--color-on-surface)] shadow-[5px_5px_0px_0px_var(--color-on-surface)] inline-block mt-1 text-[var(--color-on-surface)] -rotate-0.5 hover:rotate-0 transition-transform">TERMINAL.</span>
          </h2>
          <p className="font-body-lg text-lg sm:text-xl text-[var(--color-surface-container-highest)] max-w-3xl font-bold mt-1 px-2 py-1 bg-[var(--color-on-surface)] inline-block anim-spring-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 mt-4">
          <div className="anim-spring-4 neo-card-lift group bg-[var(--color-surface-container-lowest)] border-4 border-[var(--color-on-surface)] shadow-[8px_8px_0px_0px_var(--color-on-surface)] flex flex-col hover:shadow-[12px_12px_0px_0px_var(--color-on-surface)] hover:-translate-y-1 transition-all">
          ...
          <div className="anim-spring-5 neo-card-lift group bg-[var(--color-surface-container-lowest)] border-4 border-[var(--color-on-surface)] shadow-[8px_8px_0px_0px_var(--color-on-surface)] flex flex-col hover:shadow-[12px_12px_0px_0px_var(--color-on-surface)] hover:-translate-y-1 transition-all">
