...
export function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const mailtoUrl = `mailto:harana2912@gmail.com?subject=${encodeURIComponent(`Portfolio Contact from ${formData.name}`)}&body=${encodeURIComponent(`Name: ${formData.name}\nEmail: ${formData.email}\n\nMessage:\n${formData.message}`)}`;
  ...
  return (
    <section className="reveal-on-scroll relative w-full border-b-4 border-[var(--color-on-surface)] bg-[var(--color-surface)] py-[var(--spacing-space-lg)] lg:py-[var(--spacing-space-xl)] px-[var(--spacing-gutter)]" id="contact" style={{ backgroundImage: "linear-gradient(var(--color-on-surface) 1px, transparent 1px), linear-gradient(90deg, var(--color-on-surface) 1px, transparent 1px)", backgroundSize: "40px 40px" }}>
      ...
      <div className="relative max-w-7xl mx-auto flex flex-col gap-10">
        ...
        <div className="flex flex-col gap-3 items-center text-center max-w-3xl mx-auto bg-[var(--color-surface)] p-6 border-4 border-[var(--color-on-surface)] shadow-[8px_8px_0px_0px_var(--color-on-surface)]">
          <div className="flex flex-wrap items-center justify-center gap-3 anim-spring-1">
            ...
            <span className="px-2 py-0.5 bg-[var(--color-tertiary-container)] border-2 border-[var(--color-on-surface)] shadow-[2px_2px_0px_0px_var(--color-on-surface)] font-label-caps text-[var(--font-label-caps)] font-bold text-[var(--color-on-surface)] float-badge-2 cursor-default select-none">
              INITIATE COMMS
            </span>
          </div>
          <h2 className="font-display text-3xl sm:text-5xl lg:text-6xl font-extrabold uppercase text-[var(--color-on-surface)] tracking-tight leading-[1.05] mt-2 anim-spring-2">
            OPEN FOR <br className="hidden sm:inline" />
            <span className="bg-[var(--color-secondary-container)] px-2 border-4 border-[var(--color-on-surface)] shadow-[5px_5px_0px_0px_var(--color-on-surface)] inline-block mt-1 -rotate-0.5 hover:rotate-0 transition-transform">NEW CONNECTIONS.</span>
          </h2>
          <p className="font-body-lg text-lg sm:text-xl text-[var(--color-on-surface-variant)] font-medium mt-3 anim-spring-3">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 mt-6">
          ...
          <div className="anim-spring-4 neo-card-lift bg-[var(--color-surface-container-lowest)] border-4 border-[var(--color-on-surface)] shadow-[10px_10px_0px_0px_var(--color-on-surface)] p-6 sm:p-8">
          ...
          <div className="anim-spring-5 flex flex-col gap-6">
            
            <div className="neo-card-lift bg-[var(--color-surface-container)] border-4 border-[var(--color-on-surface)] shadow-[8px_8px_0px_0px_var(--color-on-surface)] flex flex-col">
              ...
              <div className="p-6 font-label-code text-xs sm:text-sm text-[var(--color-on-surface)] flex flex-col gap-2 bg-[var(--color-surface-container-low)]">
                ...
                <div className="flex gap-2">
                  <span className="text-[var(--color-tertiary)]">&gt;</span>
                  <span>Host: <strong className="text-[var(--color-primary)] bg-[var(--color-primary-container)] px-1">Kendid29@developer</strong></span>
                </div>
                <div className="flex gap-2">
                  <span className="text-[var(--color-tertiary)]">&gt;</span>
            ...
            <div className="neo-card-lift bg-[var(--color-surface-container-lowest)] border-4 border-[var(--color-on-surface)] shadow-[8px_8px_0px_0px_var(--color-on-surface)] p-6 flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-3">
                <a href="https://github.com/Kendid29" target="_blank" rel="noopener noreferrer" className="group flex items-center justify-between p-3 bg-[var(--color-surface)] border-2 border-[var(--color-on-surface)] hover:bg-[var(--color-primary-container)] hover:-translate-y-1 shadow-[2px_2px_0px_0px_var(--color-on-surface)] hover:shadow-[4px_4px_0px_0px_var(--color-on-surface)] transition-all cursor-pointer">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-label-code text-sm font-bold text-[var(--color-on-surface)]">GITHUB://Kendid29</span>
                  </div>
                ...
                <a href="https://www.linkedin.com/in/hadid-rayyan-nandana-baa42b378" target="_blank" rel="noopener noreferrer" className="group flex items-center justify-between p-3 bg-[var(--color-surface)] border-2 border-[var(--color-on-surface)] hover:bg-[var(--color-tertiary-container)] hover:-translate-y-1 shadow-[2px_2px_0px_0px_var(--color-on-surface)] hover:shadow-[4px_4px_0px_0px_var(--color-on-surface)] transition-all cursor-pointer">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-label-code text-sm font-bold text-[var(--color-on-surface)]">LINKEDIN://Hadid-Rayyan-Nandana</span>
                  </div>
                  <span className="px-2 py-0.5 bg-[var(--color-surface-container-lowest)] border border-[var(--color-on-surface)] font-label-caps text-[10px] font-black uppercase text-[var(--color-on-surface)] group-hover:bg-[var(--color-on-surface)] group-hover:text-[var(--color-surface)] transition-colors">CONNECT ↗</span>
                </a>
                <a href="mailto:harana2912@gmail.com" className="group flex items-center justify-between p-3 bg-[var(--color-surface)] border-2 border-[var(--color-on-surface)] hover:bg-[var(--color-secondary-container)] hover:-translate-y-1 shadow-[2px_2px_0px_0px_var(--color-on-surface)] hover:shadow-[4px_4px_0px_0px_var(--color-on-surface)] transition-all cursor-pointer">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-label-code text-sm font-bold text-[var(--color-on-surface)]">DIRECT://harana2912@gmail.com</span>
                  </div>
