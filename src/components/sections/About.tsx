...
export function About() {
  return (
    <section className="reveal-on-scroll relative w-full border-b-4 border-[var(--color-on-surface)] bg-[var(--color-surface-container-lowest)] py-[var(--spacing-space-lg)] lg:py-[var(--spacing-space-xl)] px-[var(--spacing-gutter)]" id="about" style={{ backgroundImage: "radial-gradient(var(--color-on-surface) 1px, transparent 1px)", backgroundSize: "24px 24px" }}>
      <div className="max-w-7xl mx-auto flex flex-col gap-10">
        ...
        <div className="flex flex-col gap-3">
          <div className="flex flex-wrap items-center gap-3 anim-spring-1">
            <span className="px-3 py-1 bg-[var(--color-tertiary-container)] border-2 border-[var(--color-on-surface)] shadow-[3px_3px_0px_0px_var(--color-on-surface)] font-label-code text-xs font-bold uppercase tracking-wider text-[var(--color-on-surface)]">
              // 01. IDENTITY &amp; PHILOSOPHY
            </span>
            <span className="px-2 py-0.5 bg-[var(--color-primary-container)] border-2 border-[var(--color-on-surface)] shadow-[2px_2px_0px_0px_var(--color-on-surface)] font-label-caps text-[var(--font-label-caps)] font-black text-[var(--color-on-surface)] float-badge-1 cursor-default select-none">
              DEEP DIVE
            </span>
          </div>
          <h2 className="font-display text-3xl sm:text-5xl lg:text-6xl font-extrabold uppercase text-[var(--color-on-surface)] tracking-tight leading-[1.05] anim-spring-2">
            ...
            <span className="bg-[var(--color-primary-container)] px-2 border-4 border-[var(--color-on-surface)] shadow-[5px_5px_0px_0px_var(--color-on-surface)] inline-block mt-1 -rotate-0.5 hover:rotate-0 transition-transform">BUILDING REAL SOLUTIONS.</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Pillar Card 1 */}
          <div className="anim-spring-4 neo-card-lift bg-[var(--color-surface)] border-4 border-[var(--color-on-surface)] shadow-[6px_6px_0px_0px_var(--color-on-surface)] p-6 flex flex-col justify-between">
            <div>
          ...
          {/* Pillar Card 2 */}
          <div className="anim-spring-5 neo-card-lift bg-[var(--color-surface)] border-4 border-[var(--color-on-surface)] shadow-[6px_6px_0px_0px_var(--color-on-surface)] p-6 flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between pb-4 border-b-2 border-[var(--color-on-surface)]">
          ...
          {/* Pillar Card 3 */}
          <div className="anim-spring-6 neo-card-lift bg-[var(--color-surface)] border-4 border-[var(--color-on-surface)] shadow-[6px_6px_0px_0px_var(--color-on-surface)] p-6 flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between pb-4 border-b-2 border-[var(--color-on-surface)]">
        ...
        <div className="anim-spring-6 w-full bg-[var(--color-surface-container)] border-4 border-[var(--color-on-surface)] shadow-[8px_8px_0px_0px_var(--color-on-surface)] overflow-hidden">
          <div className="bg-[var(--color-on-surface)] text-[var(--color-surface)] px-4 py-2.5 flex items-center justify-between border-b-4 border-[var(--color-on-surface)] font-label-code text-xs">
            ...
            <span className="hidden sm:inline-flex items-center gap-1.5 font-label-caps text-[11px] bg-[var(--color-primary-container)] text-[var(--color-on-surface)] px-2 py-0.5 font-bold">
              <span className="w-2 h-2 rounded-full bg-[var(--color-on-surface)] animate-ping"></span>
              STATUS: OK
            </span>
          </div>
          <div className="p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 font-label-code">
            {/* Field 1 */}
            <div className="flex flex-col gap-1 p-3 bg-[var(--color-surface-container-lowest)] border-2 border-[var(--color-on-surface)] shadow-[2px_2px_0px_0px_var(--color-on-surface)] hover:-translate-y-0.5 transition-transform">
