...
export function Journey() {
  ...
  return (
    <section className="reveal-on-scroll relative w-full border-b-4 border-[var(--color-on-surface)] bg-[var(--color-surface)] py-[var(--spacing-space-lg)] lg:py-[var(--spacing-space-xl)] px-[var(--spacing-gutter)]" id="journey">
      <div className="max-w-7xl mx-auto flex flex-col gap-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-6 border-b-4 border-[var(--color-on-surface)]">
          <div className="flex flex-col gap-3">
            <div className="flex flex-wrap items-center gap-3 anim-spring-1">
              <span className="px-3 py-1 bg-[var(--color-secondary-container)] border-2 border-[var(--color-on-surface)] shadow-[3px_3px_0px_0px_var(--color-on-surface)] font-label-code text-xs font-black uppercase tracking-wider text-[var(--color-on-surface)]">
                // 04. PROGRESSION VECTOR // MILESTONES
              </span>
              <span className="px-2 py-0.5 bg-[var(--color-surface-container)] border-2 border-[var(--color-on-surface)] shadow-[2px_2px_0px_0px_var(--color-on-surface)] font-label-caps text-[var(--font-label-caps)] font-bold text-[var(--color-on-surface)]">
                CHRONOLOGICAL LOG
              </span>
              <span className="hidden sm:inline-flex items-center gap-1.5 px-2 py-0.5 bg-[var(--color-primary-container)] border border-[var(--color-on-surface)] font-label-code text-[11px] font-bold float-badge-1 cursor-default select-none">
            ...
            <h2 className="font-display text-3xl sm:text-5xl lg:text-6xl font-extrabold uppercase text-[var(--color-on-surface)] tracking-tight leading-[1.05] anim-spring-2">
              ...
              <span className="bg-[var(--color-primary-container)] px-2 border-4 border-[var(--color-on-surface)] shadow-[5px_5px_0px_0px_var(--color-on-surface)] inline-block mt-1 -rotate-0.5 hover:rotate-0 transition-transform">&amp; EXPEDITION.</span>
            </h2>
          ...
          <div className="flex flex-col gap-2 items-start md:items-end anim-spring-3">
            ...
            <div className="flex flex-wrap gap-2" id="timelineFilters">
              <button onClick={() => setFilter("all")} className={`timeline-tag-filter px-3 py-1.5 border-2 border-[var(--color-on-surface)] shadow-[3px_3px_0px_0px_var(--color-on-surface)] font-label-caps text-xs font-bold cursor-pointer transition-all ${filter === "all" ? "active-filter" : "bg-[var(--color-surface-container-lowest)] hover:bg-[var(--color-primary-container)]"}`} type="button">SHOW ALL (4)</button>
              <button onClick={() => setFilter("2024")} className={`timeline-tag-filter px-3 py-1.5 border-2 border-[var(--color-on-surface)] shadow-[3px_3px_0px_0px_var(--color-on-surface)] font-label-caps text-xs font-bold cursor-pointer transition-all ${filter === "2024" ? "active-filter" : "bg-[var(--color-surface-container-lowest)] hover:bg-[var(--color-tertiary-container)]"}`} type="button">2024 LOGIC</button>
              <button onClick={() => setFilter("2025")} className={`timeline-tag-filter px-3 py-1.5 border-2 border-[var(--color-on-surface)] shadow-[3px_3px_0px_0px_var(--color-on-surface)] font-label-caps text-xs font-bold cursor-pointer transition-all ${filter === "2025" ? "active-filter" : "bg-[var(--color-surface-container-lowest)] hover:bg-[var(--color-tertiary-container)]"}`} type="button">2025 FRAMEWORKS</button>
              <button onClick={() => setFilter("2026")} className={`timeline-tag-filter px-3 py-1.5 border-2 border-[var(--color-on-surface)] shadow-[3px_3px_0px_0px_var(--color-on-surface)] font-label-caps text-xs font-bold cursor-pointer transition-all ${filter === "2026" ? "active-filter" : "bg-[var(--color-surface-container-lowest)] hover:bg-[var(--color-primary-container)]"}`} type="button">2026 PROD</button>
              <button onClick={() => setFilter("now")} className={`timeline-tag-filter px-3 py-1.5 border-2 border-[var(--color-on-surface)] shadow-[3px_3px_0px_0px_var(--color-on-surface)] font-label-caps text-xs font-bold cursor-pointer transition-all ${filter === "now" ? "active-filter" : "bg-[var(--color-surface-container-lowest)] hover:bg-[var(--color-secondary-container)]"}`} type="button">NOW HORIZONS</button>
            </div>
          </div>
        </div>
        ...
        <div className="relative flex flex-col gap-8 before:absolute before:top-4 before:bottom-4 before:left-4 sm:before:left-8 before:w-1.5 before:bg-[var(--color-on-surface)]">
          ...
          {/* 2024 */}
          <div className={`anim-spring-3 timeline-milestone relative items-start gap-6 sm:gap-10 pl-10 sm:pl-16 group ${(filter === "all" || filter === "2024") ? "flex" : "hidden"}`}>
            <div className="absolute left-1.5 sm:left-5.5 -top-1 w-7 h-7 bg-[var(--color-surface-container-lowest)] border-3 border-[var(--color-on-surface)] shadow-[2px_2px_0px_0px_var(--color-on-surface)] flex items-center justify-center -translate-x-1/2 group-hover:bg-[var(--color-primary-container)] transition-colors z-10">
            ...
            <div className="timeline-card w-full bg-[var(--color-surface-container-lowest)] border-4 border-[var(--color-on-surface)] shadow-[6px_6px_0px_0px_var(--color-on-surface)] p-6 transition-all duration-200">
          ...
          <div className={`timeline-milestone relative items-start gap-6 sm:gap-10 pl-10 sm:pl-16 group ${(filter === "all" || filter === "2025") ? "flex" : "hidden"}`}>
            <div className="absolute left-1.5 sm:left-5.5 -top-1 w-7 h-7 bg-[var(--color-surface-container-lowest)] border-3 border-[var(--color-on-surface)] shadow-[2px_2px_0px_0px_var(--color-on-surface)] flex items-center justify-center -translate-x-1/2 group-hover:bg-[var(--color-tertiary-container)] transition-colors z-10">
            ...
            <div className="timeline-card w-full bg-[var(--color-surface-container-lowest)] border-4 border-[var(--color-on-surface)] shadow-[6px_6px_0px_0px_var(--color-on-surface)] p-6 transition-all duration-200">
              <div className="flex flex-wrap items-center justify-between gap-2 pb-3 border-b-2 border-[var(--color-on-surface)]">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-headline-sm text-lg sm:text-xl font-bold uppercase text-[var(--color-on-surface)]">FRAMEWORKS, REACT &amp; MODERN STACKS</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="font-label-code text-xs font-bold text-[var(--color-on-surface-variant)]">EXPANDING CAPACITY</span>
              ...
              <p className="font-body-md text-[var(--color-on-surface-variant)] text-sm sm:text-base mt-3 leading-relaxed">
                Leaped from raw foundations into modern declarative frontend paradigms. Mastered React state hooks, modular styling with Tailwind CSS, and full typed safety via TypeScript.
              </p>
              <ul className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-2 font-label-code text-xs text-[var(--color-on-surface)]">
                <li className="flex items-center gap-2">
                  ...
                  <span>React functional components &amp; custom hooks</span>
                </li>
                <li className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-[var(--color-tertiary)] font-bold" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" /></svg>
                  <span>TypeScript interfaces, generics &amp; strict typing</span>
                </li>
                <li className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-[var(--color-tertiary)] font-bold" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" /></svg>
                  <span>Tailwind CSS utility tokens &amp; layout systems</span>
                </li>
                <li className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-[var(--color-tertiary)] font-bold" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" /></svg>
                  <span>Asynchronous REST integrations &amp; payload mapping</span>
                </li>
              </ul>
              {openDrawers["2025"] && (
                <div className="timeline-drawer mt-4 pt-4 border-t-2 border-dashed border-[var(--color-on-surface)]/20 flex flex-col gap-3">
                  <div className="p-3 bg-[var(--color-surface-container)] border-2 border-[var(--color-on-surface)] text-xs font-label-code flex flex-col gap-1">
                    ...
                    <p className="text-[var(--color-on-surface-variant)]">Built interactive client wedding platforms, experimented with complex CSS animations, implemented atomic component structures.</p>
                  </div>
                  <div className="flex items-center justify-between font-label-code text-xs">
                    <span className="text-[var(--color-on-surface)] font-bold">LOG_HASH: 0x2025_FRAMEWORKS_INIT</span>
                    <button onClick={() => handleCopy("0x2025_FRAMEWORKS_INIT")} className="copy-log-btn px-2 py-1 bg-[var(--color-tertiary-container)] border border-[var(--color-on-surface)] font-bold flex items-center gap-1 hover:bg-[var(--color-on-surface)] hover:text-[var(--color-surface)] transition-colors cursor-pointer" type="button">
                      <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" /></svg>
                      <span>COPY REF</span>
                    </button>
                  </div>
          ...
          {/* 2026 */}
          <div className={`anim-spring-5 timeline-milestone relative items-start gap-6 sm:gap-10 pl-10 sm:pl-16 group ${(filter === "all" || filter === "2026") ? "flex" : "hidden"}`}>
            <div className="absolute left-1.5 sm:left-5.5 -top-1 w-7 h-7 bg-[var(--color-surface-container-lowest)] border-3 border-[var(--color-on-surface)] shadow-[2px_2px_0px_0px_var(--color-on-surface)] flex items-center justify-center -translate-x-1/2 group-hover:bg-[var(--color-primary-container)] transition-colors z-10">
          ...
          {/* NOW */}
          <div className={`anim-spring-6 timeline-milestone relative items-start gap-6 sm:gap-10 pl-10 sm:pl-16 group ${(filter === "all" || filter === "now") ? "flex" : "hidden"}`}>
            <div className="absolute left-1.5 sm:left-5.5 -top-1 w-7 h-7 bg-[var(--color-secondary-container)] border-3 border-[var(--color-on-surface)] shadow-[2px_2px_0px_0px_var(--color-on-surface)] flex items-center justify-center -translate-x-1/2 z-10">
